...
const Calendar = ({ currentMonth, selectedDate, onDateClick, onPrevMonth, onNextMonth, events }) => {
    ...
    const hasEvent = (date) => events.some(eventDate => isSameDay(date, new Date(eventDate)));
    ...
    const renderDay = (date) => {
        ...
        return (
            <div
                ...
                } ${isSelected ? 'bg-black text-white' : ''} ${isEventDay ? 'bg-blue-500 text-white' : ''}`}
